...
storage_account_name = "formula02dl"
...
mount_adls("presentation-csv")

# COMMAND ----------

dbutils.fs.ls("/mnt/formula02dl/presentation-csv")

# COMMAND ----------

dbutils.fs.ls("/mnt/formula02dl/processed")

# COMMAND ----------

dbutils.fs.ls("/mnt/formula02dl/raw")

# COMMAND ----------

dbutils.fs.ls("/mnt/formula02dl/presentation")